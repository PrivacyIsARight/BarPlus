 ...
 - Brutal: Regular resources for you, +100% for the enemy
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
		...
		unitloadout = {
			...
			{name = 'corexp', x = 1888, y = 237, z = 2800, rot = 16384 , team = 1},
			...
			{name = 'cormex', x = 5488, y = 198, z = 2704, rot = 16384 , team = 1},
			{name = 'cormex', x = 5760, y = 198, z = 2496, rot = 16384 , team = 1},
			{name = 'cormex', x = 5664, y = 198, z = 2192, rot = 16384 , team = 1},
			...
			{name = 'corexp', x = 3712, y = 237, z = 1376, rot = 16384 , team = 1},
			...
			{name = 'cormex', x = 5888, y = 79, z = 608, rot = 16384 , team = 1},
			{name = 'cormex', x = 5888, y = 77, z = 256, rot = 16384 , team = 1},
			{name = 'cormex', x = 4992, y = 178, z = 560, rot = 16384 , team = 1},
			{name = 'corexp', x = 4480, y = 78, z = 944, rot = 16384 , team = 1},
			{name = 'corexp', x = 4144, y = 230, z = 192, rot = 16384 , team = 1},
