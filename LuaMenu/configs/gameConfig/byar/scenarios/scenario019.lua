 ...
 - Brutal: Regular resources for you, +100% for the enemy
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
		...
		unitloadout = {
			...
			{name = 'armmex', x = 960, y = 1101, z = 1600, rot = 32767 , team = 1},
			{name = 'armmex', x = 752, y = 1104, z = 1488, rot = 32767 , team = 1},
			{name = 'armmex', x = 768, y = 1101, z = 1872, rot = 32767 , team = 1},
			...
			{name = 'armmex', x = 816, y = 1112, z = 4384, rot = 32767 , team = 1},
			{name = 'armmex', x = 1056, y = 1125, z = 4464, rot = 32767 , team = 1},
			{name = 'armmex', x = 752, y = 1112, z = 4144, rot = 32767 , team = 1},
			...
			{name = 'armmex', x = 2352, y = 894, z = 752, rot = 32767 , team = 1},
