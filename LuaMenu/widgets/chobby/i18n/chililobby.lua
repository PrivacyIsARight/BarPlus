return {
	...
	en = {
		...
		ingame_skirmish = "In a skirmish game",
		ingame_ranked   = "In a ranked game",
		ingame_team     = "In a team game",
		ingame_1v1      = "In a 1v1 game",
		ingame_ffa      = "In a FFA game",
		ingame_coop     = "In a coop game",
		ingame_custom   = "In a custom game",
		ingame_ranked_team = "In a ranked team game",
		ingame_ranked_1v1  = "In a ranked 1v1 game",
		ingame_ranked_ffa  = "In a ranked FFA game",
		ingame_ranked_coop = "In a ranked coop game",
		ingame_ranked_custom = "In a ranked custom game",
